...
class Staticmaps:
    ...
    def compute_static_maps(self, remplir_bords=True) -> tuple[AscGrid, AscGrid, AscGrid]:
        ...
        AscSlope_angles = AscGrid(slope_angles, corners=self.ascsoil_forvalues.corners, cellsize=self.cellsize, no_data=self.ascsoil_forvalues.no_data)
        ...
        AscAire = AscGrid(acc_aire, corners=self.ascsoil_forvalues.corners, cellsize=self.cellsize, no_data=self.ascsoil_forvalues.no_data)
        ...
        return(AscSlope_angles, AscAire, AscRainAcc)
