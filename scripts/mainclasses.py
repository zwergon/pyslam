...
if __name__ == "__main__":
    ...
    feuille_experience = path/"data"/"feuille_exp.csv"
    ...
    with open(feuille_experience, "r") as file:
        ...
        for line in file:
            ...
            path_i = path_out/ f"{dico_params["numéro"]}" #le i-skipped sert à avoir une numérotation linéaire (ie sans trous là où on a skip).
            path_i.mkdir()
